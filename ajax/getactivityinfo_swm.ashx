<%@ WebHandler Language="C#" Class="getactivityinfo_swm" %>
using System;
using System.Data;
...
public class getactivityinfo_swm : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            string temp = GetPermitPrizeActivityID("9", "", DateTime.Now.ToString());
            if (!temp.Equals("0"))
            {
                result = "{\"flag\":\"1\",\"acid\":\"9\",\"jpdata\":[{\"tpid\":\"1\",\"pervl\":\"100\",\"awid\":\"0\",\"prvl\":\"1.00\",\"awnm\":\"\"}]}";
            } 
        }
