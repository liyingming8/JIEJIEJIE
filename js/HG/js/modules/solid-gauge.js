    ...
    l = {
        initDataClasses: function(b) {
            ...
            k(b.dataClasses, function(f, h) {
                ...
                c.push(f);
                if (!f.color)
                    d.dataClassColor === "category" ? (p = i.options.colors, f.color = p[g++], g === p.length && (g = 0)) : f.color = e.tweenColors(a.Color(d.minColor),
        ...
        initStops: function(b) {
            ...
            k(this.stops, function(b) { b.color = a.Color(b[1]) })
        },
