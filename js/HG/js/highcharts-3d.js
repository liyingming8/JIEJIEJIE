...
(function(d) { typeof module === "object" && module.exports ? module.exports = d : d(Highcharts) })(function(d) {
    ...
    function D(c) { return c !== void 0 && c !== null }
    ...
    function J(c) {
        if (this.chart.is3d()) {
            ...
            d.each(this.data, function(b) { if (b.y !== null)b = b.pointAttr, this.borderColor = d.pick(a.edgeColor, b[""].fill), b[""].stroke = this.borderColor, b.hover.stroke = d.pick(e.hover.edgeColor, this.borderColor), b.select.stroke = d.pick(e.select.edgeColor, this.borderColor) })
        }
    ...
    d.SVGRenderer.prototype.cuboid = function(c) {
        ...
        b.attr = function(a) {
            if (a.shapeArgs || D(a.x))
                a = this.renderer.cuboidPath(a.shapeArgs || a), this.front.attr({ d: a[0], zIndex: a[3] }), this.top.attr({
                    d: a[1],
                    zIndex: a[4]
    ...
    d.SVGRenderer.prototype.cuboidPath = function(c) {
        ...
        var a = c.x,
            ...
            i = o(i, d.charts[this.chartIndex], c.insidePlotArea),
            f = function(a, c) {
                var e = [],
                    a = k(a, b),
                    c = k(c, b);
    ...
    d.SVGRenderer.prototype.arc3d = function(c) {
        ...
        A(["opacity", "translateX", "translateY", "visibility"], function(b) {
            a[b + "Setter"] = function(b, c) {
                a[c] = b;
                A(["out", "inn", "side1", "side2", "top"], function(e) { a[e].attr(c, b) })
            }
        });
        ...
        K(a, "animate", function(a, c, e, d) {
            ...
            if (e.duration && (c = G(c), f = b(c)))
                l = f, e.step = function(a, b) {
                    function c(a) { return m[a] + (s(l[a], m[a]) - m[a]) * b.pos }
    ...
    d.SVGRenderer.prototype.arc3dPath = function(c) {
        ...
        g = c * 1E5;
        e *= 1E5;
        return{ top: k, zTop: n * 1E5 + 1, out: i, zOut: Math.max(d, g, e), inn: m, zInn: Math.max(d, g, e), side1: x, zSide1: e * 0.99, side2: a, zSide2: g * 0.99 }
    };
    ...
    d.wrap(d.Chart.prototype, "isInsidePlot", function(c) { return this.is3d() || c.apply(this, [].slice.call(arguments, 1)) });
    ...
    d.wrap(d.Axis.prototype, "setOptions", function(c, b) {
        ...
        c.call(this, b);
        if (this.chart.is3d())
            a = this.options, a.tickWidth = d.pick(a.tickWidth, 0), a.gridLineWidth =
    ...
    d.wrap(d.Axis.prototype, "render", function(c) {
        ...
        if (this.chart.is3d()) {
            ...
            if (!this.isZAxis)
                this.horiz ? (h = { x: m, y: l + (b.xAxis[0].opposite ? -g.size : k), z: 0, width: i, height: g.size, depth: j, insidePlotArea: !1 }, this.bottomFrame ? this.bottomFrame.animate(h) : this.bottomFrame = a.cuboid(h).attr({
                    fill: g.color,
    ...
    d.wrap(d.Axis.prototype, "getTitlePosition", function(c) {
        ...
        if (b)a = o([this.swapZ({ x: a.x, y: a.y, z: 0 })], this.chart, !1)[0], a[this.horiz ? "y" : "x"] += (this.horiz ? 1 : -1) * (this.opposite ? -1 : 1) * d, this.axisTitleMargin = d;
        return a
    });
    ...
    d.wrap(d.seriesTypes.pie.prototype, "animate", function(c) {
        if (this.chart.is3d()) {
            ...
            if (d.svg)
                if (a === !0 && (a = {}), b) {
                    if (f.oldtranslateX = f.translateX, f.oldtranslateY = f.translateY, b = { translateX: e[0], translateY: e[1], scaleX: 0.001, scaleY: 0.001 }, f.attr(b), g)g.attrSetters = f.attrSetters, g.attr(b)
    ...
    if (d.VMLRenderer)
        d.setOptions({ animate: !1 }), d.VMLRenderer.prototype.cuboid = d.SVGRenderer.prototype.cuboid,
