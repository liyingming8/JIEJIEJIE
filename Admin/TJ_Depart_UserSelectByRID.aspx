<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_Depart_UserSelectByRID.aspx.cs" Inherits="Admin_TJ_Depart_UserSelectByRID" %>
...
<body>
    <form id="form1" defaultbutton="BtnSearch0" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <input type="button" value="新增" class="btn btn-warning btnyd" onclick="openWinCenter('TJ_UserAddEdit.aspx?cmd=add', 680, 580, '用户编辑')" />
                </div>
                <div class="topitem">
