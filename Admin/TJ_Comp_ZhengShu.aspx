<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_Comp_ZhengShu.aspx.cs" Inherits="Admin_TJ_Comp_ZhengShu" %>
...
<body>
    <form id="form1" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_Comp_ZhengShuAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 680,680,'资质证书')" /></div>
                <div class="topitem"><span></span></div>
                <div class="topitem">
                    <asp:DropDownList ID="DDLField" runat="server"> 
                        <asp:ListItem Value="zsnm">证书名称</asp:ListItem> 
                    </asp:DropDownList>
                </div>
            ...
            <div style="overflow-x: auto;">
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="id"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="证书名称">
                            <ItemTemplate>
                                <asp:Label ID="Labelzsnm" runat="server" Text='<%# Bind("zsnm") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="图像">
                            <ItemTemplate>
                                <asp:Label ID="Labelpicurlstring" runat="server" Text='<%# Bind("picurlstring") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="显示">
                            <ItemTemplate>
                                <asp:Label ID="Labelisshow" runat="server" Text='<%# Bind("isshow") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField> 
