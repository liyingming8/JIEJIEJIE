<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_CompanyDiscoutInfo.aspx.cs" Inherits="Admin_TJ_CompanyDiscoutInfo" %>
                ...
                <table  class="tdbg">
                    <tr> 
                        <td><asp:DropDownList ID="DDLField" runat="server">
                                             <asp:ListItem Value="CDSCID">CDSCID</asp:ListItem>
                                             <asp:ListItem Value="Remarks">Remarks</asp:ListItem>
                                         </asp:DropDownList>
                            包含<input id="inputSearchKeyword" type="text" runat="server" placeholder="请输入查找内容" class="inputtext" /><asp:Button ID="BtnSearch0" runat="server" Text="查找" CssClass="inputbutton" onclick="BtnSearch0_Click" /></td><td>相关操作:</td><td><a href="TJ_CompanyDiscoutInfoAddEdit.aspx?cmd=add"><img title="添加" src="images/add.png" border="0"></a></td></tr></table>
                <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="CDSCID"
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="CDSCID" DataNavigateUrlFormatString="TJ_CompanyDiscoutInfoAddEdit.aspx?cmd=edit&ID={0}" Text="详细" />
                        <asp:TemplateField HeaderText="CDSCID">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtCDSCID" runat="server"  MaxLength="4"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="LabelCDSCID" runat="server" Text='<%# Bind("CDSCID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
