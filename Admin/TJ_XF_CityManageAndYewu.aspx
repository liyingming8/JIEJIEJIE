<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_XF_CityManageAndYewu.aspx.cs" Inherits="Admin_TJ_XF_CityManageAndYewu" %>
...
<div class="container topdiv"> 
    <div class="topitem"><input id="add" runat="server" type="button" class="btn btn-warning btnyd" value="选择"/></div><div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server"> 
<asp:ListItem Value="yewudaibiaona">业务代表</asp:ListItem>
<asp:ListItem Value="authorname">授权人</asp:ListItem>
             </asp:DropDownList>
        </div>
         ...
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="业务代表">
                    <ItemTemplate>
                        <asp:Label ID="Labelyewudaibiaona" runat="server" Text='<%# Bind("yewudaibiaona") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="授权人">
                    <ItemTemplate>
                        <asp:Label ID="Labelauthoruid" runat="server" Text='<%# Bind("authorname") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
