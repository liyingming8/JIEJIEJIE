<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_YiChangShenBaoInfo.aspx.cs" Inherits="Admin_TJ_YiChangShenBaoInfo" %>
        ...
        <div class="container topdiv">
            ...
            <div class="topitem">
                <asp:DropDownList ID="DDLField" runat="server">
                    <asp:ListItem Value="uname">用户名</asp:ListItem>
            ...
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="id"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="图像">
                        <ItemTemplate>
                            <img id="img" runat="server" src='<%#"..\\"+ Eval("imgurl").ToString() %>' height="50"/> 
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="有效">
                        <ItemTemplate>
                            <asp:CheckBox runat="server" ID="check_iscorrect" Enabled="False" Checked='<%# Eval("iscorrect").ToString().Equals("1") %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="是否处理">
                        <ItemTemplate>
                            <asp:CheckBox runat="server" ID="check_isconfirm" Enabled="False" Checked='<%# Eval("isconfirm").ToString().Equals("1") %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="结论">
                        <ItemTemplate>
                            <asp:Label ID="Labelconfirmstr" runat="server" Text='<%# Bind("confirmstr") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="处理人">
                        <ItemTemplate>
                            <asp:Label ID="Labeldealuserid" runat="server" Text='<%# Bind("dealuserid") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
