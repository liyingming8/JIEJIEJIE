...
public partial class Admin_TJ_Information : AuthorPage
{
    ...
    {
        bll.Delete(int.Parse(GridView1.DataKeys[e.RowIndex]["IFID"].ToString()));
        fillgridview();
    }
    ...
    {
        mod = bll.GetList(int.Parse(GridView1.DataKeys[e.RowIndex]["IFID"].ToString()));
        mod.IFTypeID = Convert.ToInt32(((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtIFTypeID")).Text.Trim());
        ...
        mod.TitleInfo = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtTitleInfo")).Text.Trim();
        mod.ContentInfo = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtContentInfo")).Text.Trim();
