<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_WHBuJiangUsedAndEdit.aspx.cs" Inherits="Admin_TJ_WHBuJiangUsedAndEdit" %>
            ...
            <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" AllowPaging="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="标签序号">
                        <ItemTemplate>
                            <asp:Label ID="LabelCodeInfo" runat="server" Text='<%# Bind("LabelCodeInfo") %>' maxlength="5"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="积分值">
                        <ItemTemplate>
                            <asp:Label ID="prizevl" runat="server" Text='<%# Bind("prizevl") %>' maxlength="5"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="领取人昵称">
                        <ItemTemplate>
                            <asp:Label ID="NickName" runat="server" Text='<%# Bind("NickName") %>' maxlength="5"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="领取时间">
                        <ItemTemplate>
                            <asp:Label ID="gettm" runat="server" Text='<%# Bind("gettm") %>' maxlength="5"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>         
                </Columns>
