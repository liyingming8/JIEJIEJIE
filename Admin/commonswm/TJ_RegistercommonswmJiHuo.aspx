<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_RegistercommonswmJiHuo.aspx.cs" Inherits="Admin_commonswm_TJ_RegistercommonswmJiHuo" %>
    ...
    <form id="form1" defaultbutton="BtnSearch0" runat="server">
        <div class="div_WholePage">
            ...
            <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server"
                AutoGenerateColumns="False" DataKeyNames="CompID,CompTypeID" OnRowDataBound="GridView1_RowDataBound" CssClass="GridViewStyle" PageSize="18">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="类型">
                        <ItemTemplate>
                            <asp:Label ID="LabelCompType" runat="server" Text='<%# CompTypeID(Eval("CompTypeID").ToString()) %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>                 
