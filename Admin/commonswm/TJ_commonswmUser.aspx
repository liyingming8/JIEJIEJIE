<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_commonswmUser.aspx.cs" Inherits="Admin_commonswm_TJ_commonswmUser" %>
...
<body>
    <form id="form1" defaultbutton="BtnSearch0" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <input type="button" value="新增" class="btn btn-warning btnyd" onclick="openWinCenter('TJ_commonswmUserAddEdit.aspx?cmd=add', 600, 580, '用户编辑')" />
                </div> 
                <div class="topitem">
                    ...
                    <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server"  
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="来自">
                                <ItemTemplate>
                                    <asp:Label ID="LabelFromCityID" runat="server" Text='<%# Eval("AddressInfo").ToString() %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="OpenID">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="labelWXNumber" Text='<%#Eval("WXNumber") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
