<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_RegistercommonswmCompanys.aspx.cs" Inherits="Admin_commonswm_TJ_RegistercommonswmCompanys" %>
...
<body>
    <form id="form1" defaultbutton="BtnSearch0" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <input type="button" value="新增" class="btn btn-warning btnyd" onclick="openWinCenter('TJ_RegistercommonswmCompanysAddEdit.aspx?cmd=add', 780, 520, '公司信息')" />
                </div>
                <div class="topitem">
            ...
            <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server"
               ...
               <%--     <asp:TemplateField HeaderText="公司类别">
                    ...
                    <asp:TemplateField HeaderText="状态">
                        <ItemTemplate>
                            <asp:Label ID="LabelCompAutherID" runat="server"
                                Text='<%# comfun.ReturnBaseClassName(Eval("CompAutherID").ToString(), false, false) %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="手机">
                        <ItemTemplate>
                            <asp:Label ID="LabelTelNumber" runat="server" Text='<%# Bind("MobilePhoneNumber") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField> 
