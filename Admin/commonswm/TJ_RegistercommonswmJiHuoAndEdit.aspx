<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_RegistercommonswmJiHuoAndEdit.aspx.cs" Inherits="Admin_commonswm_TJ_RegistercommonswmJiHuoAndEdit" %>
                ...
                <ContentTemplate>
                    <table class="gridtable"> 
                        ...
                        <tr>
                            <th>状态</th>
                            <td>
                                <asp:RadioButton ID="radOff" runat="server"  Text="未激活" Checked="true" GroupName="type"/>
                                <asp:RadioButton ID="radOn" runat="server" Text="激活" GroupName="type" />
                            </td>
                        </tr>
                        <tr>
