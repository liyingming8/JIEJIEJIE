...
public partial class Admin_commonswm_TJ_RegisterCompanysAddEdit : AuthorPage
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            _mod.IsCompany = CheckBox_IsCompany.Checked;
            _mod.UseSWM = true;
    ...
    private void Fillinput(int id)
    {
        ...
        CheckBox_IsCompany.Checked = ms.IsCompany;
    }
