...
public partial class Admin_commonswm_TJ_commonswmUser : AuthorPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Response.AddHeader("Refresh", "3000");
    ...
    public string XiangXiLinkString(string ID)
    {
        ...
        {
            //双击后编辑修改方法
            return string.Format("javascript:var win=openWinCenter('TJ_commonswmUserAddEdit.aspx?cmd=edit&ID={0}',580,580,' 用户编辑')", ID);
        }
        else
        {
            return "";
