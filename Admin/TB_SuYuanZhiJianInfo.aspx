<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_SuYuanZhiJianInfo.aspx.cs" Inherits="Admin_TB_SuYuanZhiJianInfo" %>
    ...
    <form id="form1" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <div class="topitem">
                        <input type="button" value="新增" class="btn btn-warning btnyd" onclick="openWinCenter('TB_SuYuanZhiJianInfoAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 450,300,'质检员')" />
                    </div>
                    <asp:DropDownList ID="DDLField" runat="server">
                        <asp:ListItem Value="ZhiJianName">姓名</asp:ListItem>
            ...
            <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="ID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="质检员名称">
                        <ItemTemplate>
                            <asp:Label ID="LabelZhiJianName" runat="server" Text='<%# Bind("ZhiJianName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
