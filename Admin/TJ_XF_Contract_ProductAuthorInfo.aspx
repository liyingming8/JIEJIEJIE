<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_XF_Contract_ProductAuthorInfo.aspx.cs" Inherits="Admin_TJ_XF_Contract_ProductAuthorInfo" %>
...
<div class="container topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_XF_Contract_ProductAuthorInfoAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'TJ_XF_Contract_ProductAuthorInfo')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server">
<asp:ListItem Value="id">id</asp:ListItem>
<asp:ListItem Value="procode">procode</asp:ListItem>
<asp:ListItem Value="authorizedarea">authorizedarea</asp:ListItem>
             </asp:DropDownList>
        </div>
...
<Columns>
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="ctrid">
                    <ItemTemplate>
                        <asp:Label ID="Labelctrid" runat="server" Text='<%# Bind("ctrid") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="procode">
                    <ItemTemplate>
                        <asp:Label ID="Labelprocode" runat="server" Text='<%# Bind("procode") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="authorizedarea">
                    <ItemTemplate>
                        <asp:Label ID="Labelauthorizedarea" runat="server" Text='<%# Bind("authorizedarea") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="areaid">
                    <ItemTemplate>
                        <asp:Label ID="Labelareaid" runat="server" Text='<%# Bind("areaid") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
