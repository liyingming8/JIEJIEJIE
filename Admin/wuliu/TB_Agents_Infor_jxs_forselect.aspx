<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_Agents_Infor_jxs_forselect.aspx.cs" Inherits="Admin_wuliu_TB_Agents_Infor_jxs_forselect" %> 
    ...
    <form id="form1" runat="server">
        <div class="div_WholePage">
            <div class="topdiv"> 
                <div class="topitem">
                    <asp:DropDownList ID="DDLField" runat="server">
                        <asp:ListItem Value="CompName" Selected="True">经销商</asp:ListItem>
                        ...
                        <asp:ListItem Value="Agent_Code">编码</asp:ListItem>
                    </asp:DropDownList>
                </div> 
                <div class="topitem">
                    <input id="inputSearchKeyword" type="text" runat="server" placeholder="请输入查找内容" class="inputsearch" style="width: 300px;" /></div> 
                <div class="topitem">
            ...
            <div style="overflow-x: auto">
                <asp:GridView ID="GridView1" EnableViewState="False" runat="server" PageSize="20" Width="100%" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="CompID,CompName"
        ...
        <asp:HiddenField runat="server" ID="hf_fr"/>
    </form> 
