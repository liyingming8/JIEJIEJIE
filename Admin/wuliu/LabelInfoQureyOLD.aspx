<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LabelInfoQureyOLD.aspx.cs" Inherits="Admin_wuliu_LabelInfoQureyOLD" %>
             ...
             <div class="div_WholePage">
                <div class="div_Nav">
                    <table>
                        <tr>
                            <td>
                                <asp:Label ID="Label1" runat="server" Text="标签号码:"></asp:Label></td>
                            <td >
                                <asp:Label ID="Label2" runat="server" Text="批量查询:" Visible="False"></asp:Label>
                                <asp:TextBox ID="TextBox_Label" runat="server" MaxLength="12"></asp:TextBox>
                                <asp:FileUpload ID="FileUpload1" runat="server" Visible="False" /></td>
                            <td >
                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="单枚查询" /></td>
                            <td >
                                <asp:Button ID="Button_SearchByTxt" runat="server" OnClick="Button_SearchByTxt_Click"
                                            Text="批量查询" Visible="False" />
                                <asp:CheckBox ID="CheckBox_ByTxtFile" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox_ByTxtFile_CheckedChanged"
                                              Text="批量查询" Visible="False" /></td>
                            <td>
                                </td>
                        </tr>
                    </table>
                ...
                <table>
                    <tr><td><strong>瓶箱关系</strong></td><td>
                                                          <asp:Label ID="Label3" runat="server" Visible="false" Font-Bold="true" Text="套标对应关系"></asp:Label></td>
                        <td ><strong>替换关系</strong></td>
                    </tr>
                    <tr><td style="vertical-align: top;"><asp:GridView ID="GridView_QueryResult" runat="server" BorderColor="Silver" BorderStyle="Outset"  BorderWidth="1px" CaptionAlign="Left" CellPadding="2" GridLines="Vertical"  PageSize="20" AutoGenerateColumns="False" CellSpacing="2">
                    ...
                    <SelectedRowStyle CssClass="GridViewSelectedRowStyle" /><PagerStyle CssClass="GridViewPagerStyle" /><AlternatingRowStyle CssClass="GridViewAlternatingRowStyle" /><HeaderStyle CssClass="GridViewHeaderStyle" />
                                                        </asp:GridView></div></td><td style="vertical-align: top;"><div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" BorderColor="Silver" BorderStyle="Outset"  BorderWidth="1px" CaptionAlign="Left" CellPadding="2" GridLines="Vertical"  PageSize="20">
                                                                                                                <RowStyle Height="20px" Wrap="False" />
                                                                                                                <PagerStyle BorderColor="Gray" BorderStyle="Double" BorderWidth="1px" />
                                                                                                                <EmptyDataTemplate>
                                                                                                                    尚未查询到满足条件的入库记录!
                    ...
                    <SelectedRowStyle CssClass="GridViewSelectedRowStyle" /><PagerStyle CssClass="GridViewPagerStyle" /><AlternatingRowStyle CssClass="GridViewAlternatingRowStyle" /><HeaderStyle CssClass="GridViewHeaderStyle" />
                        ...
                        <td style="vertical-align: top;">
                            <asp:GridView ID="GridView2" runat="server" Width="100%" BorderColor="Silver" BorderStyle="Outset" BorderWidth="1px" CaptionAlign="Left" CellPadding="2" GridLines="Vertical" PageSize="20" AutoGenerateColumns="False" CellSpacing="2">
                                <RowStyle Height="20px" Wrap="False" />
                                <PagerStyle BorderColor="Gray" BorderStyle="Double" BorderWidth="1px" />
                                <Columns>
                ...
                <asp:GridView ID="GridView_FaHuoXinXi" Width="100%"  runat="server" BorderColor="Silver" BorderStyle="Outset"  BorderWidth="1px" CaptionAlign="Left" CellPadding="2"  GridLines="Vertical"  PageSize="20" AutoGenerateColumns="False"> 
                    <Columns>
