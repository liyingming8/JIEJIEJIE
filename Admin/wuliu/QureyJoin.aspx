<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QureyJoin.aspx.cs" Inherits="Admin_wuliu_QureyJoin" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <asp:ListItem Value="2">地点</asp:ListItem>
                            ...
                            <asp:CheckBoxList ID="CBL_QueryMethod" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True" Value="1">电话</asp:ListItem>
                                <asp:ListItem Selected="True" Value="2">短信</asp:ListItem>
                                <asp:ListItem Selected="True" Value="3">互联网</asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
                        <td><asp:Button ID="BtnSearch0" runat="server" Text="开始汇总" CssClass="inputbutton" onclick="BtnSearch0_Click" /></td></tr></table>
                <br />
