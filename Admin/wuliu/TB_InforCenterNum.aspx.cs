...
public partial class Admin_TB_InforCenterNum : AuthorPage
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        mod.Province = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtProvince")).Text.Trim();
        mod.City = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtCity")).Text.Trim();
