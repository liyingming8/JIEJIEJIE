...
public partial class Admin_TB_CompAgentInfo : AuthorPage
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        mod.Middleman = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtMiddleman")).Text.Trim();
        mod.AllowArea = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtAllowArea")).Text.Trim();
