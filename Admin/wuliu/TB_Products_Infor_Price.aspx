<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_Products_Infor_Price.aspx.cs" Inherits="Admin_TB_Products_Infor_Price" %>
        ...
        <form id="form1" runat="server">
            <div>
                ...
                <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="Infor_ID"
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="Infor_ID" DataNavigateUrlFormatString="TB_Products_InforAddEdit.aspx?cmd=edit&ID={0}" Text="详细" />
