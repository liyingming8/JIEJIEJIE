<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_Agents_Infor_forselect.aspx.cs" Inherits="Admin_wuliu_TB_Agents_Infor_forselect" %> 
...
<body>
    <form id="form1" runat="server">
        <div class="div_WholePage">
            ...
            <webdiyer:AspNetPager ID="AspNetPager1" ShowFirstLast="True" runat="server" CssClass="GridViewPagerStyle" PageSize="8" NextPageText="下一页" PrevPageText="上一页" PageIndexBoxType="DropDownList" SubmitButtonText="Go" TextAfterPageIndexBox="页" TextBeforePageIndexBox="转到" FirstPageText="首页" LastPageText="尾页" NumericButtonCount="5" OnPageChanging="AspNetPager1_PageChanging" CustomInfoHTML="" CustomInfoSectionWidth=""></webdiyer:AspNetPager>
        </div> 
