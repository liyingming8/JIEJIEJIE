<%@ Page Language="C#" AutoEventWireup="true" CodeFile="commonswmdelivery.aspx.cs" Inherits="Admin_wuliu_commonswmdelivery" %>
        ...
        <div class="div_WholePage">
            <div class="topdiv"> 
                <div class="topitem">
                 ...
                 <div class="topitem">
                    <asp:DropDownList ID="ddlagent" DataTextField="CompName" DataValueField="CompID" runat="server" AppendDataBoundItems="True">
                        <asp:ListItem Value="0">全部</asp:ListItem>
                    </asp:DropDownList>
                </div>
                <div class="topitem">
