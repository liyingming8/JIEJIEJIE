<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FaHuoDetial.aspx.cs" Inherits="Admin_wuliu_Fahuo_FaHuoDetial" %> 
            ...
            <div style="background-color: white; border-radius: 6px; border: 1px solid gray; padding: 5px 5px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td nowrap="nowrap">
                            <asp:DropDownList ID="ComboBox_DaiLiShangID" runat="server" AppendDataBoundItems="true" DataTextField="CompName" DataValueField="CompID" Width="73px">
