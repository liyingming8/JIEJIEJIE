...
public partial class Admin_wuliu_Fahuo_FaHuoLYH : Page
{
    private CommonFunWL com = new CommonFunWL();
    private commwl comm = new commwl();
    private string[] codearrytemp = new string[0];
    private ArrayList strList = new ArrayList();
    private ArrayList stroneList = new ArrayList();
            ...
            if (oFile != null)
            {
...

                {
                    if (Session["liuyanghe"] != null)
                    {
                        ...
                        Session.Add("liuyanghe", dttempline);
                    }
                    else
                    {
