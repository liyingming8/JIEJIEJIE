<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_ProductAuthorForAgentAddEdit.aspx.cs" Inherits="Admin_TB_ProductAuthorForAgentAddEdit" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>TB_ProductAuthorForAgent</title>
                    ...
                    <tr>
                        <td valign="middle">
                            <table class="user_box" cellspacing="0" cellpadding="5" width="100%" border="0" id="table2">
                                <tr><td align="left"><span style="font-size: 12pt; font-weight: bold; color: #3666AA"><img src="images/icon.gif" align="middle" style="border-width: 0px;" /> TB_ProductAuthorForAgent</span></td>
   ...
   <table class="gridtable">
                    <tr><th>ATHPID</th><td><input id="inputATHPID" runat="server" type="text" maxlength="2" /></td></tr>
                    ...
                    <tr><th>ProdID</th><td><input id="inputProdID" runat="server" type="text" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" maxlength="4" /></td></tr>
                    <tr><th>CreateDate</th><td><input id="inputCreateDate" runat="server" type="text" maxlength="8" /></td></tr>
                    <tr><th>ActiveDate</th><td><input id="inputActiveDate" runat="server" type="text" maxlength="8" /></td></tr>
