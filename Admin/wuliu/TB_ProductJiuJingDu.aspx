<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_ProductJiuJingDu.aspx.cs" Inherits="Admin_TB_ProductJiuJingDu" %>
    ...
    <body>
        <form id="form1" runat="server">
            <div class="div_WholePage">
                <div class="topdiv">
                 <div class="topitem"><input type="button" value="新增" class="btn btn-warning btnyd" onclick="openWinCenter('TB_ProductJiuJingDuAddEdit.aspx?cmd=add', 450, 300, '酒精度编辑')" /></div>
