<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_ProducStandardsAddEdit.aspx.cs" Inherits="Admin_TB_ProducStandardsAddEdit" %>
        ...
        <form id="form1" runat="server">
            ...
            <ContentTemplate> 
                <table class="gridtable">
                    <tr><th>规格</th><td><input id="inputStandarsDes" runat="server" type="text" maxlength="50" /></td></tr>
