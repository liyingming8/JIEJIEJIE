<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_KuCunSendedAddEdit.aspx.cs" Inherits="Admin_TB_KuCunSendedAddEdit" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>TB_KuCunSended</title>
              ...
              <div class="editpageback">
                    ...
                    <tr>
                        <td valign="middle">
                            <table class="user_box" cellspacing="0" cellpadding="5" width="100%" border="0" id="table2">
                                <tr><td align="left"><span style="font-size: 12pt; font-weight: bold; color: #3666AA"><img src="images/icon.gif" align="middle" style="border-width: 0px;" /> TB_KuCunSended</span></td>
                ...
                <br />
                  <table class="gridtable">
                    ...
                    <tr><th>Send_Time</th><td><input id="inputSend_Time" runat="server" type="text" maxlength="8" /></td><td></td></tr>
                    <tr><th>Contents</th><td><input id="inputContents" runat="server" type="text" maxlength="100" /></td><td></td></tr>
