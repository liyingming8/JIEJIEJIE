<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_Products_Infor_tongyong_AddEdit.aspx.cs"
    Inherits="Admin_TB_Products_Infor_tongyong_AddEdit" %> 
                ...
                <ContentTemplate>
                    <table class="gridtable">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <textarea id="txtProducts_Summary" runat="server" class="p80" cols="20" rows="3"></textarea>
                            </td>
                        </tr> 
                    </table>
