<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_RecivedMSAddEdit.aspx.cs" Inherits="Admin_TB_RecivedMSAddEdit" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>TB_RecivedMS</title>
        ...
        <form id="form1" runat="server">
              <div class="editpageback">
                    ...
                    <tr>
                        <td valign="middle">
                            <table class="user_box" cellspacing="0" cellpadding="5" width="100%" border="0" id="table2">
                                <tr><td align="left"><span style="font-size: 12pt; font-weight: bold; color: #3666AA"><img src="images/icon.gif" align="middle" style="border-width: 0px;" /> TB_RecivedMS</span></td>
               ...
               <table class="gridtable">
                    ...
                    <tr><th>returnvalue</th><td><input id="inputreturnvalue" runat="server" type="text" maxlength="40" /></td></tr>
                    <tr><th>IsReturn</th><td><input id="inputIsReturn" runat="server" type="text" maxlength="5" /></td></tr>
