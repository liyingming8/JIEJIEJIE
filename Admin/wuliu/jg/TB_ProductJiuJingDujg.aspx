<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_ProductJiuJingDujg.aspx.cs" Inherits="Admin_TB_ProductJiuJingDujg" %>
        ...
        <form id="form1" runat="server">
            <div>
                <table  class="tdbg">
                    <tr> 
                        <td><asp:DropDownList ID="DDLField" runat="server">
                                             <asp:ListItem Value="JiuJingDuShu">酒精度</asp:ListItem>
                                             <asp:ListItem Value="Remarks">备注</asp:ListItem>
                                         </asp:DropDownList>
                            包含<input id="inputSearchKeyword" type="text" runat="server" class="inputsearch"  placeholder="请输入查找内容"  /><asp:Button ID="BtnSearch0" runat="server" Text="查找" CssClass="inputbutton" onclick="BtnSearch0_Click" /></td><td>相关操作:</td><td><a href="TB_ProductJiuJingDuAddEditjg.aspx?cmd=add"><img title="添加" src="../../images/add.png" border="0"></a></td></tr></table>
                <br />
                <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" AllowPaging="True"　  AutoGenerateColumns="False" DataKeyNames="ID"
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="TB_ProductJiuJingDuAddEditjg.aspx?cmd=edit&ID={0}" Text="详细" />
                        <asp:TemplateField HeaderText="酒精度">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtJiuJingDuShu" runat="server"  Text='<%# Bind("JiuJingDuShu") %>'  MaxLength="30"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="LabelJiuJingDuShu" runat="server" Text='<%# Bind("JiuJingDuShu") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
