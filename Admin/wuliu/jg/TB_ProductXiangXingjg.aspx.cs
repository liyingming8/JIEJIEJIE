...
public partial class Admin_TB_ProductXiangXingjg : AuthorPage
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            if (!bproduct.CheckIsExistByFilterString("ProductXiangXing=" + GridView1.DataKeys[e.Row.RowIndex][0]))
            {
