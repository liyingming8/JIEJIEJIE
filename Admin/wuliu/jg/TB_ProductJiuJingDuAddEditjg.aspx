<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_ProductJiuJingDuAddEditjg.aspx.cs" Inherits="Admin_TB_ProductJiuJingDuAddEditjg" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>TB_ProductJiuJingDu</title>
    ...
    <body>
        <form id="form1" runat="server">
            <div>
                    ...
                    <tr>
                        <td valign="middle">
                            <table class="user_box" cellspacing="0" cellpadding="5" width="100%" border="0" id="table2">
                                <tr><td align="left"><span style="font-size: 12pt; font-weight: bold; color: #3666AA"><img src="../../images/icon.gif" align="middle" style="border-width: 0px;" /> 酒精度编辑</span></td>
                ...
                <br />
                <table>
                    <tr><td>酒精度</td><td><input id="inputJiuJingDuShu" runat="server" type="text" maxlength="15" /></td><td>
                                                                                                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="inputJiuJingDuShu" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                                                                                       </td></tr>
