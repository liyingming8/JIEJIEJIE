<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_ProducStandardsAddEditjg.aspx.cs" Inherits="Admin_TB_ProducStandardsAddEditjg" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>TB_ProducStandards</title>
    ...
    <body>
        <form id="form1" runat="server">
            <div>
                    ...
                    <tr>
                        <td valign="middle">
                            <table class="user_box" cellspacing="0" cellpadding="5" width="100%" border="0" id="table2">
                                <tr><td align="left"><span style="font-size: 12pt; font-weight: bold; color: #3666AA"><img src="../../images/icon.gif" align="middle" style="border-width: 0px;" /> 产品规格</span></td>
                ...
                <br />
                <table>
                    <tr><td>规格</td><td><input id="inputStandarsDes" runat="server" type="text" maxlength="50" /></td><td>
                                                                                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="inputStandarsDes" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                                                                                     </td></tr>
