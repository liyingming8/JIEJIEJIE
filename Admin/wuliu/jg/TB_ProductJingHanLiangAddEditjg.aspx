<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_ProductJingHanLiangAddEditjg.aspx.cs" Inherits="Admin_TB_ProductJingHanLiangAddEditjg" %>
    ...
    <body>
        <form id="form1" runat="server">
            <div>
                    ...
                    <tr>
                        <td valign="middle">
                            <table class="user_box" cellspacing="0" cellpadding="5" width="100%" border="0" id="table2">
                                <tr><td align="left"><span style="font-size: 12pt; font-weight: bold; color: #3666AA"><img src="../../images/icon.gif" align="middle" style="border-width: 0px;" /> 净含量编辑</span></td>
                ...
                <br />
                <table>
                    <tr><td>净含量</td><td><input id="inputJingHanLiang" runat="server" type="text" maxlength="15" /></td><td>
                                                                                                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="inputJingHanLiang" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                                                                                       </td></tr>
