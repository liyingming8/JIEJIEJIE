...
public partial class Admin_TB_ProductJiuJingDujg : AuthorPage
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            if (!bproduct.CheckIsExistByFilterString("ProductJiuJingDu=" + GridView1.DataKeys[e.Row.RowIndex][0]))
            {
