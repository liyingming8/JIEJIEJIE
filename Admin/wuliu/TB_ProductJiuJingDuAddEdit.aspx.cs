...
public partial class Admin_TB_ProductJiuJingDuAddEdit : AuthorPage
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //===wyz===20170921==================
        if (mod.JiuJingDuShu.Equals(""))
        {
            ScriptManager.RegisterStartupScript(UpdatePanel1, GetType(), "info", "alert('酒精度不能为空！');", true);
            return;
        }
        //===wyz===20170921==================
