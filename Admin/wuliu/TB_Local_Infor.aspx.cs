...
public partial class Admin_TB_Local_Infor : AuthorPage
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        mod.PID = Convert.ToInt32(((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtPID")).Text.Trim());
        mod.CID = Convert.ToInt32(((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtCID")).Text.Trim());
        mod.Server = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtServer")).Text.Trim();
        mod.CenterNumber = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtCenterNumber")).Text.Trim();
