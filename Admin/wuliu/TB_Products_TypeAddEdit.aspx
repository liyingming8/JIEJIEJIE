<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_Products_TypeAddEdit.aspx.cs" Inherits="Admin_TB_Products_TypeAddEdit" %>
        ...
        <form id="form1" runat="server">
              ...
              <asp:ScriptManager ID="ScriptManager1" runat="server">
                ...
                <table class="gridtable">
                    ...
                    <tr><th>类型编码</th><td><input id="inputTypeCode" runat="server" type="text" maxlength="30" /></td></tr>
                    <tr><th>类型名称</th><td><input id="inputTypeName" runat="server" type="text" maxlength="25" /></td><td>
