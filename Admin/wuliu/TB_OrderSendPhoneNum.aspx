<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_OrderSendPhoneNum.aspx.cs" Inherits="Admin_TB_OrderSendPhoneNum" %>
        ...
        <form id="form1" runat="server">
            <div>
                <table  class="tdbg">
                    <tr> 
                        <td><asp:DropDownList ID="DDLField" runat="server">
                            ...
                            包含<input id="inputSearchKeyword" type="text" runat="server" placeholder="请输入查找内容"  class="inputsearch" /><asp:Button ID="BtnSearch0" runat="server" Text="查找" CssClass="inputbutton" onclick="BtnSearch0_Click" /></td><td>相关操作:</td><td><a href="TB_OrderSendPhoneNumAddEdit.aspx?cmd=add"><img title="添加" src="images/add.png" border="0"></a></td></tr></table>
                <br />
                <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="ID"
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="TB_OrderSendPhoneNumAddEdit.aspx?cmd=edit&ID={0}" Text="详细" />
                        ...
                        <asp:TemplateField HeaderText="Master">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtMaster" runat="server"  MaxLength="10"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Remarks">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtRemarks" runat="server"  MaxLength="20"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
