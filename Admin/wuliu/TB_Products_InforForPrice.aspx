<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_Products_InforForPrice.aspx.cs" Inherits="Admin_TB_Products_InforForPrice" %>
                ...
                <table  class="tdbg">
                    <tr>
                        <td><asp:DropDownList ID="DDLField" runat="server">
                            ...
                            包含<input id="inputSearchKeyword" type="text" runat="server" placeholder="请输入查找内容"  class="inputsearch" /><asp:Button ID="BtnSearch0" runat="server" Text="查找" CssClass="inputbutton" onclick="BtnSearch0_Click" /></td><td>相关操作:</td><td><a href="TB_Products_InforAddEdit.aspx?cmd=add"><img title="添加" src="../images/add.png" border="0"></a></td></tr></table>
                <br />
                <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" AllowPaging="True"　 AutoGenerateColumns="False" DataKeyNames="Infor_ID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="产品名称">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtProducts_Name" runat="server"  Text='<%# Bind("Products_Name") %>' MaxLength="20"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="价格">
                            <ItemTemplate>
                                ￥<asp:HyperLink ID="hplink" runat="server" NavigateUrl='<%# JiageLinkString(Eval("Infor_ID").ToString()) %>' Text='<%# ((Eval("Products_Price").Equals(DBNull.Value) || Eval("Products_Price").ToString().Trim().Length == 0) ? "添加" : Eval("Products_Price").ToString()) %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
