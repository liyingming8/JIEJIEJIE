...
public partial class Admin_TB_WaittingSend : AuthorPage
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        mod.State = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtState")).Text.Trim();
        mod.MSGCenterNo = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtMSGCenterNo")).Text.Trim();
