<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_WaittingSend.aspx.cs" Inherits="Admin_TB_WaittingSend" %>
        ...
        <form id="form1" runat="server">
            <div>
                <table  class="tdbg">
                    <tr> 
                        <td><asp:DropDownList ID="DDLField" runat="server">
                                             ...
                                             <asp:ListItem Value="MSGCenterNo">MSGCenterNo</asp:ListItem>
                                             <asp:ListItem Value="Remarks">Remarks</asp:ListItem>
                                         </asp:DropDownList>
                            包含<input id="inputSearchKeyword" type="text" runat="server" class="inputsearch" placeholder="请输入查找内容"  /><asp:Button ID="BtnSearch0" runat="server" Text="查找" CssClass="inputbutton" onclick="BtnSearch0_Click" /></td><td>相关操作:</td><td><a href="TB_WaittingSendAddEdit.aspx?cmd=add"><img title="添加" src="images/add.png" border="0"></a></td></tr></table>
                <br />
                <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="ID"
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="TB_WaittingSendAddEdit.aspx?cmd=edit&ID={0}" Text="详细" />
                        ...
                        <asp:TemplateField HeaderText="MSGCenterNo">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtMSGCenterNo" runat="server"  MaxLength="20"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="LabelMSGCenterNo" runat="server" Text='<%# Bind("MSGCenterNo") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
