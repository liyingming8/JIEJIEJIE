...
public partial class Admin_TB_ReplaceInfo : AuthorPage
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        mod.NewLabelCode = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtNewLabelCode")).Text.Trim();
        mod.OldLabelCode = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtOldLabelCode")).Text.Trim();
        mod.UpDateTime =
