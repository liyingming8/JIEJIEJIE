<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_Agents_Infor_Terminal_ShenHe.aspx.cs" Inherits="Admin_TB_Agents_Infor_Terminal_ShenHe" %> 
    ...
    <form id="form1" runat="server">
        <div class="div_WholePage">
            ...
            <div style="overflow-x: auto">
                <asp:GridView ID="GridView1" EnableViewState="False" runat="server" PageSize="20" Width="100%" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="CompID,CompName" OnRowDataBound="GridView1_RowDataBound" CssClass="GridViewStyle" OnRowDeleting="GridView1_RowDeleting">
                    <Columns>
