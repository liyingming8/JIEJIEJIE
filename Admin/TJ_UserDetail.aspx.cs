...
public partial class Admin_TJ_UserDetail : AuthorPage
{
    ...
    {
        bll.Delete(int.Parse(GridView1.DataKeys[e.RowIndex]["UserDetailID"].ToString()));
        fillgridview();
    }
    ...
    {
        mod.UserDetailID =
            Convert.ToInt32(((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtUserDetailID")).Text.Trim());
        ...
        mod.Birthday = Convert.ToDateTime(((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtBirthday")).Text.Trim());
        mod.Address = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtAddress")).Text.Trim();
        mod.IdentificationCode = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtIdentificationCode")).Text.Trim();
        ...
        mod.QQ = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtQQ")).Text.Trim();
        mod.WeiXinNumber = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtWeiXinNumber")).Text.Trim();
