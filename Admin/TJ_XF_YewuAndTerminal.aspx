<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_XF_YewuAndTerminal.aspx.cs" Inherits="Admin_TJ_XF_YewuAndTerminal" %>
...
<div class="container topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_XF_YewuAndTerminalAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'TJ_XF_YewuAndTerminal')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server">
<asp:ListItem Value="id">id</asp:ListItem>
<asp:ListItem Value="terminalname">terminalname</asp:ListItem>
...
<Columns>
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="yewuuserid">
                    <ItemTemplate>
                        <asp:Label ID="Labelyewuuserid" runat="server" Text='<%# Bind("yewuuserid") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="terminalid">
                    <ItemTemplate>
                        <asp:Label ID="Labelterminalid" runat="server" Text='<%# Bind("terminalid") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="terminalname">
                    <ItemTemplate>
                        <asp:Label ID="Labelterminalname" runat="server" Text='<%# Bind("terminalname") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
