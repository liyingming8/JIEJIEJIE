...
public partial class Admin_TJ_VanCarryingAbility : AuthorPage
{
    ...
    {
        bll.Delete(int.Parse(GridView1.DataKeys[e.RowIndex]["VanCarryAbID"].ToString()));
        fillgridview();
    }
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        mod.CarryAbility =
            Convert.ToDecimal(((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtCarryAbility")).Text.Trim());
        bll.Modify(mod);
        GridView1.EditIndex = -1;
        fillgridview();
    }
