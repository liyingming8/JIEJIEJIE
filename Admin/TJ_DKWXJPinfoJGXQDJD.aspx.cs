...
public partial class TJ_DKWXJPinfoJGXQDJD : AuthorPage
{
    ...
    {
        tempstring = "DJDian=" + GetCookieCompID() + " and DJflag=1";
        ...
        {
            tempstring += "and LQDateTime >='" + txtStartDate.Text + "' and  CONVERT(varchar(12) , LQDateTime, 23 ) <='" +
                          txtEndDate.Text + "'";
        }
        tempstring += "order by LQDateTime desc";
        return tempstring;
    }
