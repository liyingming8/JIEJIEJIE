<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_WXSMreport.aspx.cs" Inherits="TB_WXSMreport" %>
    ...
    <form runat="server">
        <div class="div_WholePage">
            <div class="topdiv" style="position: relative; z-index: 100">
                <div class="topitem"><span>月份</span></div>
                <div class="topitem">
                    <input id="txtStartDate" class="inputdatenew" type="text" runat="server" />
                </div>
                <div class="topitem"><span>至</span></div>
                <div class="topitem">
                    <input id="txtEndDate" class="inputdatenew" type="text" runat="server" />
                </div>
                <div class="topitem">
