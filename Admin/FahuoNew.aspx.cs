...
public partial class yanshi_Fahuo_FahuoNew : AuthorPage
{
    ...
    protected void Button_Insert_Click(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(updatepanel, GetType(), "info", "alert('发货成功!')", true);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Session.Remove("dttempline");
        Session.Remove("strList");
        ScriptManager.RegisterStartupScript(updatepanel, GetType(), "info", "alert('清除成功！'); ", true);
    }
}