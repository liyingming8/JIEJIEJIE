<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_SWM_PriceDiscountMode.aspx.cs" Inherits="Admin_TJ_SWM_PriceDiscountMode" %>
...
<body>
    <form id="form1" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_SWM_PriceDiscountModeAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'三维码折扣模式')" /></div>
                <div class="topitem"><span></span></div>
                <div class="topitem">
                    <asp:DropDownList ID="DDLField" runat="server"> 
                        <asp:ListItem Value="jieshao">介绍</asp:ListItem>
                ...
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="id"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="数量">
                            <ItemTemplate>
                                <asp:Label ID="Labelshuliang" runat="server" Text='<%# Bind("shuliang") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="介绍">
                            <ItemTemplate>
                                <asp:Label ID="Labeljieshao" runat="server" Text='<%# Bind("jieshao") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
