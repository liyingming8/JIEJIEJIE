...
public partial class Admin_TJ_ZJLabelCodesmallInfo : AuthorPage
{
    ...
    {
        AspNetPager1.RecordCount = int.Parse(_tab.ExecuteQuery("select count(*) from TJ_ZJLabelCodesmallInfo where " + Filtertemp, null).Rows[0][0].ToString());
        GridView1.DataSource = _tab.ExecuteQueryByProPagerNew(pageIndex, "TJ_ZJLabelCodesmallInfo", Filtertemp, "ZJCDID", "ZJCDID", pageSize);
        GridView1.DataBind();
    }
