...
public partial class Admin_TJ_UserUploadInfo : AuthorPage
{
    ...
    {
        bll.Delete(int.Parse(GridView1.DataKeys[e.RowIndex]["UULID"].ToString()));
        fillgridview();
    }
    ...
    {
        mod = bll.GetList(int.Parse(GridView1.DataKeys[e.RowIndex]["UULID"].ToString()));
        ...
        mod.PathString = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtPathString")).Text.Trim();
