<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TB_SuYuanKuFang.aspx.cs" Inherits="Admin_TB_SuYuanKuFang" %>
...
<body>
    <form id="form1" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TB_SuYuanKuFangAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 500,320,'库房信息')" /></div>
                <div class="topitem"><span></span></div>
                <div class="topitem">
                    <asp:DropDownList ID="DDLField" runat="server">
                        <asp:ListItem Value="KuFang">库房</asp:ListItem>
            ...
            <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="ID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="库房">
                        <ItemTemplate>
                            <asp:Label ID="LabelKuFang" runat="server" Text='<%# Bind("KuFang") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="类别">
                        <ItemTemplate>
                            <asp:Label ID="LabelKuFangType" runat="server" Text='<%# BtjBaseClass.GetList(int.Parse(Eval("KuFangType").ToString())).CName %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
