<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_CompTheme_color.aspx.cs" Inherits="Admin_TJ_CompTheme_color" %>
    ...
    <form id="form1" runat="server">
        <div class="div_WholePage">
            <div class="topdiv" id="topdiv" runat="server">
                <div class="topitem">
                    <input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_CompTheme_colorAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>    ', 600,450,'TJ_CompTheme_color')" /></div>
                <div class="topitem"><span></span></div>
                <div class="topitem">
                    <asp:DropDownList ID="DDLField" runat="server">
                        <asp:ListItem Value="id">id</asp:ListItem>
                        <asp:ListItem Value="themecolor">themecolor</asp:ListItem>
                        <asp:ListItem Value="path">path</asp:ListItem>
            ...
            <div>
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="id"
                    ...
                    <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="主题色">
                            <ItemTemplate>
                                <asp:Label ID="Labelthemecolor" runat="server" Text='<%# Bind("themecolor") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
