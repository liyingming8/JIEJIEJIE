<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_XF_Contract.aspx.cs" Inherits="Admin_TJ_XF_Contract" %>
...
<div class="container topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_XF_ContractAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'TJ_XF_Contract')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
...
<Columns>
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="updtid">
                    <ItemTemplate>
                        <asp:Label ID="Labelupdtid" runat="server" Text='<%# Bind("updtid") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
