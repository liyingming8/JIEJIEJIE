<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_Activity_Product.aspx.cs" Inherits="Admin_TJ_Activity_Product" %>
    ...
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="选取" runat="server"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server"> 
                <asp:ListItem Value="prodnm">产品</asp:ListItem>
             </asp:DropDownList>
        </div>
         ...
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="产品">
                    <ItemTemplate>
                        <asp:Label ID="Labelprodnm" runat="server" Text='<%# Bind("prodnm") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
