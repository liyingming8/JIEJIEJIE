<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_Depart_UserInfo.aspx.cs" Inherits="Admin_TJ_Depart_UserInfo" %> 
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate> 
                    <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server"  
                        AutoGenerateColumns="False" DataKeyNames="UserID,CompID,RID"  
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="所属单位">
                                <ItemTemplate>
                                    <asp:Label ID="LabelCompID" runat="server" Text='<%# GetCompanyNameByID(Eval("departid").ToString()) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="城市经理">
                                <ItemTemplate>
                                    <asp:HyperLink runat="server" ID="linkmanagerauthor">授权</asp:HyperLink><asp:Literal ID="literauthornum" runat="server"></asp:Literal>
                                </ItemTemplate> 
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateField>
                            <%--<asp:TemplateField HeaderText="业务代表">
                                <ItemTemplate>
                                    <asp:HyperLink runat="server" ID="linkyewudaibiaoauthor">指定</asp:HyperLink><asp:Literal ID="literorderornum" runat="server"></asp:Literal>
                                </ItemTemplate> 
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateField>--%>
