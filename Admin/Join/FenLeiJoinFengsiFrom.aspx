<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FenLeiJoinFengsiFrom.aspx.cs" Inherits="Admin_Join_FenLeiJoinFengsiFrom" %>
...
<td class="tdbg">
    ...
    <asp:RadioButtonList ID="RBL_Item" runat="server" RepeatDirection="Horizontal">
        ...
        <asp:ListItem Value="4">接入方式</asp:ListItem>
    </asp:RadioButtonList>
    </td>
