<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_AgentAcceptInfoyc.aspx.cs" Inherits="Admin_TJ_AgentAcceptInfoyc" %>
    ...
    <form id="form1" runat="server">
        <div class="div_WholePage">
            ...
            <div class="container topdiv">
                ...
                <div style="padding: 0.5rem 1rem 0 1rem; width: 100%;">
                    <asp:Literal ID="literaltihuan" runat="server"></asp:Literal>
                </div>
                <%--            <div class="topitem">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div style="overflow-x: auto;">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="ID,isexception,BoxLabel" OnRowDataBound="GridView1_RowDataBound" CssClass="GridViewStyle">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="当前父级经销商">
                                <ItemTemplate>
                                    <asp:Label ID="LabelAcceptAgentIDfj" runat="server" Text='<%#Terminalname(Eval("ParentID").ToString()) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="原发货至">
                                <ItemTemplate>
                                    <asp:Label ID="BoxLabel" runat="server" Text='<%# ToAgentID(Eval("BoxLabel").ToString()) %>'></asp:Label><asp:Label ID="lab_exception1" runat="server" Text='<%# (int.Parse(Eval("isexception").ToString()).Equals(0)?"":"*") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
