<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_SWM_PID_RPID.aspx.cs" Inherits="Admin_TJ_SWM_PID_RPID" %>
...
<body>
    <form id="form1" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_SWM_PID_RPIDAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'TJ_SWM_PID_RPID')" /></div>
            ...
            <div>
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="id"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="rpid">
                            <ItemTemplate>
                                <asp:Label ID="Labelrpid" runat="server" Text='<%# Bind("rpid") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
