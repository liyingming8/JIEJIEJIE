<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_RegisterCompanysForSelectSWM.aspx.cs" Inherits="Admin_TJ_RegisterCompanysForSelectSWM" %> 
            ...
            <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" AllowPaging="false"
                ...
                <Columns>  
                    ...
                    <asp:TemplateField HeaderText="地址">
                        <ItemTemplate>
                            <asp:Label ID="LabelCTID" runat="server" Text='<%# Eval("Address") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField> 
                </Columns>
