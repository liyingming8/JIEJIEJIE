<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_LayoutInfo.aspx.cs" Inherits="Admin_TJ_LayoutInfo" %>
...
<div class="container topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_LayoutInfoAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'TJ_LayoutInfo')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server">
<asp:ListItem Value="id">id</asp:ListItem>
<asp:ListItem Value="layoutname">layoutname</asp:ListItem>
...
<Columns>
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="layoutname">
                    <ItemTemplate>
                        <asp:Label ID="Labellayoutname" runat="server" Text='<%# Bind("layoutname") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
