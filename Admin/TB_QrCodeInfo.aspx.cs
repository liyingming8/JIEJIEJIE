...
public partial class Admin_TB_QrCodeInfo : AuthorPage
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        mod.ExplorerType = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtExplorerType")).Text.Trim();
        mod.ComputerORMobile = ((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtComputerORMobile")).Text.Trim();
        mod.CreateTime =
            Convert.ToDateTime(((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtCreateTime")).Text.Trim());
        bll.Modify(mod);
        GridView1.EditIndex = -1;
        fillgridview();
    }
