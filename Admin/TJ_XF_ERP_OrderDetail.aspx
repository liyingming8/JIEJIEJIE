<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_XF_ERP_OrderDetail.aspx.cs" Inherits="Admin_TJ_XF_ERP_OrderDetail" %>
...
<div class="container topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_XF_ERP_OrderDetailAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'TJ_XF_ERP_OrderDetail')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
...
<Columns>
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="odid">
                    <ItemTemplate>
                        <asp:Label ID="Labelodid" runat="server" Text='<%# Bind("odid") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
