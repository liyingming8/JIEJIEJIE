...
public partial class Admin_jg_TJ_IntegralInfo : AuthorPage
{
    private readonly BTJ_IntegralInfo bll = new BTJ_IntegralInfo();
    private readonly MTJ_IntegralInfo mod = new MTJ_IntegralInfo();
    ...
    {
        bll.Delete(int.Parse(GridView1.DataKeys[e.RowIndex]["ITGID"].ToString()));
        fillgridview();
    }
