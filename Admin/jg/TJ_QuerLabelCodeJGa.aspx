<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_QuerLabelCodeJGa.aspx.cs" Inherits="Admin_TJ_QuerLabelCodeJGa" %>
            ...
            <div>
                <table  class="tdbg">
                    <tr>
                        ...
                        </asp:DropDownList>--%>标签序号<input id="inputSearchKeyword" type="text" placeholder="请输入查找内容" runat="server" class="inputtext" />查询超过累计次数：<input id="inputSearchKeywordcishu" type="text" runat="server" class="inputtext" /><asp:Button ID="BtnSearch0" runat="server" Text="查找" CssClass="inputbutton" OnClick="BtnSearch0_Click" /></td>
                        <td></td>
                        <td></td>
                    </tr>
                </table>  
                <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" AllowPaging="True"　 AutoGenerateColumns="False" DataKeyNames="ID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="首次查询时间">
                            <ItemTemplate>
