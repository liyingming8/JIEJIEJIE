<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_QuerLabelCodeMingXi.aspx.cs" Inherits="Admin_jg_TJ_QuerLabelCodeMingXi" %>
                ...
                <table  class="tdbg">
                    <tr> 
                        <td><asp:DropDownList ID="DDLField" runat="server">
                            ...
                            包含<input id="inputSearchKeyword" placeholder="请输入查找内容" type="text" runat="server" class="inputtext" /><asp:Button ID="BtnSearch0" runat="server" Text="查找" CssClass="inputbutton" onclick="BtnSearch0_Click" /></td><td  ></td><td></td></tr></table>
