<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_IntegraItemsAddEditjg.aspx.cs" Inherits="Admin_TJ_IntegraItemsAddEditjg" %>
        ...
        <form id="form1" runat="server">
            <div>
                        ...
                        <td valign="middle">
                            <table class="user_box" cellspacing="0" cellpadding="5" width="100%" border="0" id="table2">
                                <tr><td align="left"><span style="font-size: 12px; font-weight: bold; color: #3666AA"><img src="../images/icon.gif" align="middle" style="border-width: 0px; margin-top: -5px;" /> 
                                                         积分项目编辑</span></td>
                                    <td align="center"><table align="center" id="table3"><tr valign="top" align="center"><td width="80"><a href="TJ_IntegraItems.aspx"><img title="返回" src="../images/back.png" border="0"></a></td><td width="100"></td><td width="100"></td><td width="100"></td></tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <table>
                            <tr><td>项目名称</td><td><input id="inputItemName" runat="server" type="text" maxlength="20" /></td><td></td></tr>
