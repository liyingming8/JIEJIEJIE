...
public partial class Admin_TJ_VanPassCitys : AuthorPage
{
    ...
    {
        bll.Delete(int.Parse(GridView1.DataKeys[e.RowIndex]["VanPassID"].ToString()));
        fillgridview();
    }
    ...
    {
        mod.VanPassID = Convert.ToInt32(((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtVanPassID")).Text.Trim());
