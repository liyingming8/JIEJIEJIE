...
(function() {
    function m() {
        ...
        a.compressSpaces = function(a) { return a ? a.replace(/[\s\r\t\n]+/gm, " ") : "" };
        a.ajax = function(a) {
            var d;
        ...
        a.Element.path = function(c) {
            ...
            this.path = function(d) {
                ...
                for (d != null && d.beginPath(); !b.isEnd();)
                    ...
                    case "Q":
                        for (; !b.isCommandOrEnd();)
                            g = b.current, h = b.getAsControlPoint(),
...
(function(m) {
    ...
    k(d.prototype, {
        ...
        configure: function(a) {
            var b = this, d = a.options.tooltip, g = d.borderWidth, h = b.ttDiv, k = d.style, m = b.ttLine, s = parseInt(k.padding, 10), k = e(k, { padding: s + "px", "background-color": d.backgroundColor, "border-style": "solid", "border-width": g + "px", "border-radius": d.borderRadius + "px" });
