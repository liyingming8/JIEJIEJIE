<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_Activity_AgentAddEdit.aspx.cs" Inherits="Admin_TJ_Activity_AgentAddEdit" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<title>TJ_Activity_Agent</title>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
    <div class="toptitle">TJ_Activity_Agent</div>
