<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_Activity_ProductAddEdit.aspx.cs" Inherits="Admin_TJ_Activity_ProductAddEdit" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<title>TJ_Activity_Product</title>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
    <div class="toptitle">TJ_Activity_Product</div>
         <table class="gridtable">
            ...
            <tr><th>prodnm</th><td><input id="inputprodnm" runat="server" type="text" maxlength="50" /></td><td></td></tr>
        </table>
