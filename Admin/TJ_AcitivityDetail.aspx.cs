...
public partial class Admin_TJ_AcitivityDetail : AuthorPage
{
    ...
    {
        bll.Delete(int.Parse(GridView1.DataKeys[e.RowIndex]["ACDTID"].ToString()));
        fillgridview();
    }
    ...
    {
        mod.ACDTID = Convert.ToInt32(((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtACDTID")).Text.Trim());
        mod.ITITID = Convert.ToInt32(((TextBox) GridView1.Rows[e.RowIndex].FindControl("txtITITID")).Text.Trim());
