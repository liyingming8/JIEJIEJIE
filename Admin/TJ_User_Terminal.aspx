<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_User_Terminal.aspx.cs" Inherits="Admin_TJ_User_Terminal" %> 
...
<body>
    <form id="form1" defaultbutton="BtnSearch0" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <input type="button" runat="server" id="btn_new" value="新增" class="btn btn-warning btnyd" />
                </div> 
                <div class="topitem">
        ...
        <input type="hidden" id="hd_compid" runat="server"/>
