<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_Activity_Agent.aspx.cs" Inherits="Admin_TJ_Activity_Agent" %>
...
<div class="topdiv"> 
    <div class="topitem"><input id="add" runat="server" type="button" class="btn btn-warning btnyd" value="选取"/></div><div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server"> 
                <asp:ListItem Value="agentname">经销商</asp:ListItem>
             </asp:DropDownList>
        </div>
...
<webdiyer:AspNetPager ID="AspNetPager1" runat="server" CssClass="GridViewPagerStyle"  PageSize="20" OnPageChanging="AspNetPager1_PageChanging" ustomInfoHTML="共%PageCount%页，当前为第%CurrentPageIndex%页" FirstPageText="首页" LastPageText="尾页" NextPageText="下一页" PrevPageText="上一页" ShowCustomInfoSection="Left" CustomInfoHTML="共%PageCount%页，当前为第%CurrentPageIndex%页，每页%PageSize%条"></webdiyer:AspNetPager>
    ...
    <input type="hidden" runat="server" id="hd_agentnm"/> 
</form>
</body>
</html>