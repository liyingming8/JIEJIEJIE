...
public partial class Admin_TJ_UploadMediaInfo : AuthorPage
{
    ...
    {
        bll.Delete(int.Parse(GridView1.DataKeys[e.RowIndex]["UPLID"].ToString()));
        fillgridview();
    }
    ...
    {
        mod = bll.GetList(int.Parse(GridView1.DataKeys[e.RowIndex]["UPLID"].ToString()));
        ...
        mod.Show = ((CheckBox) GridView1.Rows[e.RowIndex].FindControl("checkShow")).Checked;
        bll.Modify(mod);
        GridView1.EditIndex = -1;
        fillgridview();
    }
