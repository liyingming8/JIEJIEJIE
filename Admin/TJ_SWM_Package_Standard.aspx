<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_SWM_Package_Standard.aspx.cs" Inherits="Admin_TJ_SWM_Package_Standard" %>
...
<body>
    <form id="form1" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_SWM_Package_StandardAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'包装规格')" />
                </div>
                <div class="topitem"><span></span></div>
                <div class="topitem">
                    <asp:DropDownList ID="DDLField" runat="server"> 
                        <asp:ListItem Value="unitnm">单位</asp:ListItem>
                        <asp:ListItem Value="singleprice">单价</asp:ListItem> 
                ...
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="id"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="单位">
                            <ItemTemplate>
                                <asp:Label ID="Labelunitnm" runat="server" Text='<%# Bind("unitnm") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="单价">
                            <ItemTemplate>
                                ￥<asp:Label ID="Labelsingleprice" runat="server" Text='<%# Bind("singleprice") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="合计">
                          ...
                          <asp:TemplateField HeaderText="备注">
                            <ItemTemplate>
                                <asp:Label ID="Labelremark" runat="server" Text='<%# Bind("remarks") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
