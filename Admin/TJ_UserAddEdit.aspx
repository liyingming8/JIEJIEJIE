<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_UserAddEdit.aspx.cs" Inherits="Admin_TJ_UserAddEdit" %> 
                ...
                <ContentTemplate>
                    <table class="gridtable">
                        ...
                        <tr>
                            <th>密码</th>
                            <td>
                                <asp:TextBox ID="TextBox_PassWords"  autocomplete="new-password" CssClass="p30" runat="server" TextMode="Password"></asp:TextBox><asp:CheckBox ID="CheckBox_ModifyAsDefault" runat="server" Text="修改成初始密码：123456" Visible="False" /> 
                            </td>
                        </tr>
                        <tr>
                            <th>昵称</th>
