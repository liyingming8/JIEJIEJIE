<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_DepartMent_ProvinceAuthorAddEdit.aspx.cs" Inherits="Admin_TJ_DepartMent_ProvinceAuthorAddEdit" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<title>TJ_DepartMent_ProvinceAuthor</title>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
    <div class="toptitle">TJ_DepartMent_ProvinceAuthor</div>
         <table class="gridtable">
            ...
            <tr><th>provinceid</th><td><input id="inputprovinceid" runat="server" type="text" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" maxlength="4" /></td><td></td></tr>
            ...
            <tr><th>authorprovincenm</th><td><input id="inputauthorprovincenm" runat="server" type="text" maxlength="50" /></td><td></td></tr>
            <tr><th>authorusernm</th><td><input id="inputauthorusernm" runat="server" type="text" maxlength="15" /></td><td></td></tr>
        </table>
