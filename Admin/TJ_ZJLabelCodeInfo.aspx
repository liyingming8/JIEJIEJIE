<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_ZJLabelCodeInfo.aspx.cs" Inherits="Admin_TJ_ZJLabelCodeInfo" %>
...
<body>
    <form id="form1" runat="server">
        <div class="div_WholePage">
            <div class="topdiv">
                <div class="topitem">
                    <asp:DropDownList ID="DDLField" runat="server">
                        <asp:ListItem Value="BoxLabelCode">箱标</asp:ListItem>
                        <asp:ListItem Value="SaleArea">销售区域</asp:ListItem>
                ...
                <div class="topitem">
                    <asp:DropDownList ID="DDLJX" AppendDataBoundItems="true" runat="server" DataTextField="JxName" DataValueField="JxID">
                        <asp:ListItem Value="0" Text="所有奖项..." Selected="True"></asp:ListItem>
                    </asp:DropDownList>
                </div>
                <div class="topitem">
            ...
            <div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server" AllowPaging="False" AutoGenerateColumns="False" DataKeyNames="ZJCDID"
