<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TJ_MobileSite_RoleInfo.aspx.cs" Inherits="Admin_TJ_MobileSite_RoleInfo" %>
...
<div class="container topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('TJ_MobileSite_RoleInfoAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'前端角色指定')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server">
<asp:ListItem Value="id">id</asp:ListItem>
<asp:ListItem Value="rname">rname</asp:ListItem>
<asp:ListItem Value="createtm">createtm</asp:ListItem>
             </asp:DropDownList>
        </div>
         ...
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="rname">
                    <ItemTemplate>
                        <asp:Label ID="Labelrname" runat="server" Text='<%# Bind("rname") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="createuid">
                    <ItemTemplate>
                        <asp:Label ID="Labelcreateuid" runat="server" Text='<%# Bind("createuid") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="createtm">
                    <ItemTemplate>
