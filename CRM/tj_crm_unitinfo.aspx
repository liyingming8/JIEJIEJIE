<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tj_crm_unitinfo.aspx.cs" Inherits="CRM_tj_crm_unitinfo" %>
...
<div class="topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('/crm/tj_crm_unitinfoAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 410,288,'计量单位')"/></div><div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server"> 
                <asp:ListItem Value="unitname">名称</asp:ListItem>
         ...
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="单位">
                    <ItemTemplate>
                        <asp:Label ID="Labelunitname" runat="server" Text='<%# Bind("unitname") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
