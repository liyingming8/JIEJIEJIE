<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tj_crm_system_config.aspx.cs" Inherits="Admin_tj_crm_system_config" %>
...
<div class="topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('/crm/tj_crm_system_configAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'tj_crm_system_config')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server">
<asp:ListItem Value="id">id</asp:ListItem>
<asp:ListItem Value="compid">compid</asp:ListItem>
<asp:ListItem Value="logourl">logourl</asp:ListItem>
<asp:ListItem Value="hometoppicurl">hometoppicurl</asp:ListItem>
...
<div>
<div style="overflow-x:auto"><asp:GridView ID="GridView1" EnableViewState="False" runat="server"  Width="100%" AutoGenerateColumns="False" DataKeyNames=""
         ...
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="logourl">
                    <ItemTemplate>
                        <asp:Label ID="Labellogourl" runat="server" Text='<%# Bind("logourl") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="hometoppicurl">
                    <ItemTemplate>
                        <asp:Label ID="Labelhometoppicurl" runat="server" Text='<%# Bind("hometoppicurl") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
