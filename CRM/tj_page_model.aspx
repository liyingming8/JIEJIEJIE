<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tj_page_model.aspx.cs" Inherits="CRM_tj_page_model" %>
...
<div class="topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('/crm/tj_page_modelAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'模块信息')"/></div><div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server">
                  <asp:ListItem Value="pagename" Selected="True">模块</asp:ListItem>
    ...
    <asp:TemplateField HeaderText="编辑">
         ...
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="模块">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="LOGO">
                    <ItemTemplate>
                        <img src='<%# Eval("logourl").ToString() %>' width="50" height="50"/> 
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="链接">
                    <ItemTemplate>
                        <asp:Label ID="Labellinkpathstring" runat="server" Text='<%# Bind("linkpathstring") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="所属模块">
                    <ItemTemplate>
                        <asp:Label ID="Labelbelongmodel" runat="server" Text='<%# Bind("belongmodel") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="必须">
                    <ItemTemplate>
                        <asp:CheckBox runat="server" Enabled="False" ID="ckb_isneeded" Checked='<%#Convert.ToBoolean(Eval("isneeded")) %>'/>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
