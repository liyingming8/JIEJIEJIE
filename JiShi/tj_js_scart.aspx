<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tj_js_scart.aspx.cs" Inherits="Admin_tj_js_scart" %>
...
<div class="topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('tj_js_scartAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'tj_js_scart')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
