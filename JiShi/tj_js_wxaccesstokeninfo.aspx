<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tj_js_wxaccesstokeninfo.aspx.cs" Inherits="Admin_tj_js_wxaccesstokeninfo" %>
...
<div class="topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('tj_js_wxaccesstokeninfoAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'tj_js_wxaccesstokeninfo')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server">
<asp:ListItem Value="id">id</asp:ListItem>
<asp:ListItem Value="wxappid">wxappid</asp:ListItem>
<asp:ListItem Value="access_token">access_token</asp:ListItem>
<asp:ListItem Value="expires_in">expires_in</asp:ListItem>
             </asp:DropDownList>
        </div>
...
<Columns>
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="access_token">
                    <ItemTemplate>
                        <asp:Label ID="Labelaccess_token" runat="server" Text='<%# Bind("access_token") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="expires_in">
                    <ItemTemplate>
                        <asp:Label ID="Labelexpires_in" runat="server" Text='<%# Bind("expires_in") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
