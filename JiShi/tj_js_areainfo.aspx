<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tj_js_areainfo.aspx.cs" Inherits="Admin_tj_js_areainfo" %>
...
<div class="topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('tj_js_areainfoAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'tj_js_areainfo')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
             <asp:DropDownList ID="DDLField" runat="server">
<asp:ListItem Value="id">id</asp:ListItem>
<asp:ListItem Value="parentid">parentid</asp:ListItem>
<asp:ListItem Value="acode">acode</asp:ListItem>
<asp:ListItem Value="aname">aname</asp:ListItem>
             </asp:DropDownList>
        </div>
         ...
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="acode">
                    <ItemTemplate>
                        <asp:Label ID="Labelacode" runat="server" Text='<%# Bind("acode") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="aname">
                    <ItemTemplate>
