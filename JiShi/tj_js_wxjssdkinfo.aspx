<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tj_js_wxjssdkinfo.aspx.cs" Inherits="Admin_tj_js_wxjssdkinfo" %>
...
<div class="topdiv"> 
    <div class="topitem"><input id="add" type="button" class="btn btn-warning btnyd" value="新增" onclick="openWinCenter('tj_js_wxjssdkinfoAddEdit.aspx?cmd=<%=Sc.EncryptQueryString("add")%>', 600,450,'tj_js_wxjssdkinfo')"/></div>        <div class="topitem"><span></span></div>
        <div class="topitem">
...
<asp:ListItem Value="wx_js_url">wx_js_url</asp:ListItem>
...
<Columns>
         <asp:TemplateField HeaderText="序号">
             ...
             <ItemStyle HorizontalAlign="Center" Width="60px" />
                ...
                <asp:TemplateField HeaderText="wx_js_url">
                    <ItemTemplate>
                        <asp:Label ID="Labelwx_js_url" runat="server" Text='<%# Bind("wx_js_url") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
