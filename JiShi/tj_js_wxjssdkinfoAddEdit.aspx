<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tj_js_wxjssdkinfoAddEdit.aspx.cs" Inherits="Admin_tj_js_wxjssdkinfoAddEdit" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<title>tj_js_wxjssdkinfo</title>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
         <table class="gridtable">
            ...
            <tr><th>wx_js_url</th><td><input id="inputwx_js_url" runat="server" type="text"  /></td><td></td></tr>
