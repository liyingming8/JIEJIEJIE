...
function showMessageDialog(url, title, width, height, shadow) {
    ...
    var boarddiv = '<div id="msgwindow" style="border-left:1px solid #fff;-webkit-overflow-scrolling:touch;overflow:scroll;" title="' + title + '"></div>'//style="overflow:hidden;"可以去掉滚动条
