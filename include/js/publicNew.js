...
var pointbox = {
    open: function (obj) {
        if (document.getElementById("pointbox")) {
            document.getElementById("pointbox").style.bottom = "15%";
            if (obj.text)
                document.getElementById("pointbox").innerHtml = obj.text;
        }
        else {
            var odiv = document.createElement("div");
            odiv.setAttribute("id", "pointbox")
            odiv.className = "pointbox";
            odiv.innerHTML = obj.text ? obj.text : "完成";
            document.body.appendChild(odiv);
        }
        setTimeout(function () {
            document.getElementById("pointbox").style.bottom = "-50%";
        }, obj.outtime ? obj.outtime : 3000);
    } 
}
function fadein(ele) {
