<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderInfoAccepted.aspx.cs" Inherits="msite_OrderInfoAccepted" %>
<!DOCTYPE html>
        ...
        <form id="form1" runat="server">
            <div class="container-fluid">
                <div class="row navibar">
                    ...
                    <a href="OrderInfoAccepted.aspx" target="_self"><div class="col-xs-4 currentpage">已处理</div></a>
                </div>
