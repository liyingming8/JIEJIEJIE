<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderInfoNoAccept.aspx.cs" Inherits="msite_OrderInfoNoAccept" %>
<!DOCTYPE html>
        ...
        <form id="form1" runat="server">
            <div class="container-fluid">
                <div class="row navibar">
                    <a href="OrderInfoNoAccept.aspx" target="_self"><div class="col-xs-4 currentpage">待处理</div></a>
                    <a href="OrderInfoAcceptIng.aspx" target="_self"><div class="col-xs-4 notcurrentpage">处理中</div></a>
            ...
            <div class="col-xs-4"><a href="JieDan.aspx?orderid="  class="ButtonOK">我来接单</a></div>
