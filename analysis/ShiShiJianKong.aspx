<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShiShiJianKong.aspx.cs" Inherits="analysis_ShiShiJianKong" %>
    ...
    <form id="form1" runat="server">
     <div class="div_WholePage">
            <div class="topdiv" style="position: relative; z-index: 100">
                <div class="topitem">
                    <asp:Button ID="BtnSearch0" runat="server" Text="刷新" CssClass="btn btn-warning btnyd" OnClick="BtnSearch0_Click" />
                </div>
