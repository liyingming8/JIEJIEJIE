<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChuanHuoYuJing.aspx.cs" Inherits="analysis_ChuanHuoYuJing" %>
        ...
        <div id="vim">
            <div class="div_WholePage">
                ...
                <div style="overflow-x: auto">
                    ...
                    <p v-show="statistics.length==0" style="text-align:center">无窜货数据~</p>
                </div>
        ...
        var vm = new Vue({
            ...
            methods: {
                getstatistics: function () {
                    ...
                    jscript.setAttribute("src", "http://117.34.70.23:32176/gis/bugsell/statistics/" + this.compid + "/?" + (this.sm == '' ? "" : "mode=1&") + "date_from=" + this.startDate + "&date_to=" + this.endDate + "&callback=vm.receiveStatistics");
                ...
                gomap: function (index) {
                    ...
                    layer.open({
                        ...
                        maxmin: true,
                        area: ['90%', '90%'],
                        content: '../analysis/cuanhuomap.html?compid=' + this.compid + (this.sm == '' ? '' : '&mode=1') + '&agtid=' + index + "&date_from=" + this.startDate + "&date_to=" +this.endDate,
                        end: function () {
                        }
                    });
                },
                lookmore: function (index, agtname) {
                    ...
                    layer.open({
                        type: 2,
                        title: agtname + ' 的可疑窜货数据',
                        maxmin: true,
                 
                        area: ['90%', '90%'],
                        content:  '../analysis/cuanhuodata.html?compid=' + this.compid + (this.sm == '' ? '' : '&mode=1') + '&agtid=' + index + "&date_from=" + this.startDate + "&date_to=" + this.endDate,
                        end: function () {
                        }
                    });
                },
            ...
            created: function () {
                ...
                this.startDate = this.getDate(0);
                this.endDate = this.getDate(1);
