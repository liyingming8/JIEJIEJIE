<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaoMaReDian.aspx.cs" Inherits="Admin_SaoMaReDian" %>
...
<head runat="server">
    ...
    <title>扫码地图</title>
    <style>
        .nav { position: fixed; top: 2%; left: 7%; z-index: 99; width: 90%; }
    </style>
</head>
<body>
    ...
    <script>
        ...
        oInputDate.value = cx_date;

        oInputDate.onchange = function () {
            addData(this.value);
        }
        ...
        function addData() {
            ...
            jscript.setAttribute("src", "http://www.china315net.com:35222/wuliu/baidupoints/data/?company="+oCompName+"&date=" + cx_date + "&callback=jsonpBack");
