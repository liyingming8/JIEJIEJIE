...
namespace Com.Alipay
{
    ...
    public class Core
    {
        ...
        public static string BuildMysign(Dictionary<string, string> dicArray, string key, string sign_type,
        ...
        public static void LogResult(string sWord)
        {
            ...
            StreamWriter fs = new StreamWriter(strPath, false, Encoding.Default);
            fs.Write(sWord);
            fs.Close();
        }
    }
