<%@ WebHandler Language="C#" Class="InsertFaHuoInfoYin " %>
...
public class InsertFaHuoInfoYin : IHttpHandler 
{
    ...
    private string InsertTbProcessDataInfo(string strall111)//string ProductID, string MadeDate)
    {
        try
        {
            using (var myConn = GetConnectionWL())
            {
                ...
                _str1 = "insert into TB_ProcessDataInfo([Guid],[Code],[Czy],[DLS],[CP],[XH],[CK],[FHPC],[compid]) values(";
                _str4 = "insert into TB_ProcessDataInfo([Guid],[Code],[Czy],[DLS],[CP],[XH],[CK],[FHPC],[compid],[fhflag]) values(";
                _str2 = "";
                _str3 = "";
                _strfhflag = "";
                ...
                if (strall111.Trim().Contains(","))
                {
                    ...
                    _strczy = strall111.Split(',')[1].Trim();
                    _strdls = strall111.Split(',')[2].Trim();
                    _strcp = strall111.Split(',')[3].Trim();
                    _strxh = strall111.Split(',')[4].Trim();
                    _strck = strall111.Split(',')[5].Trim();
                    _strguid = strall111.Split(',')[6].Trim();
                    _strcompid = strall111.Split(',')[7].Trim();
                    if (straa.Length.Equals(9))
                    {
                        _strfhflag = strall111.Split(',')[8].Trim();
                        _str2 = "'" + _strguid + "','" + _strcode + "','" + _strczy + "','" + _strdls + "','" + _strcp + "','" + _strxh + "','" + _strck + "','" + _strBatchNo + "','" + _strcompid + "','" + _strfhflag + "');";
                        _str3 = _str3 + _str4 + _str2;
                    }
                    else
                    {
                        _strfhflag = "";
                        _str2 = "'" + _strguid + "','" + _strcode + "','" + _strczy + "','" + _strdls + "','" + _strcp + "','" + _strxh + "','" + _strck + "','" + _strBatchNo + "','" + _strcompid + "');";
