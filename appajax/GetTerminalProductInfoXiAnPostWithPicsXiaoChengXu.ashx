<%@ WebHandler Language="C#" Class="GetTerminalProductInfoXiAnPostWithPicsXiaoChengXu" %>  
using System.Text;
using System.Web;
using System.Data;
using Newtonsoft.Json;

public class GetTerminalProductInfoXiAnPostWithPicsXiaoChengXu : IHttpHandler 
{ 
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        else
        {
            ...
            {
                DataTable dt = db.GetAuthorProductInfoForJsonWithPicsForXFXCX(strcompid, agentid);
                if (dt.Rows.Count > 0)
                {
