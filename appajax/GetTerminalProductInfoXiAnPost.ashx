<%@ WebHandler Language="C#" Class="GetTerminalProductInfoXiAnPost" %>  
using System.Text;
using System.Web;
using System.Data;
using Newtonsoft.Json;

public class GetTerminalProductInfoXiAnPost : IHttpHandler 
{ 
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        else
        {
            ...
            {
                DataTable dt = db.GetAuthorProductInfoForJSON(strcompid, agentid);
                if (dt.Rows.Count > 0)
                {
