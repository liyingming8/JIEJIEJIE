<%@ WebHandler Language="C#" Class="OrperateFaHuoInfoFrankXiAn" %>

using System.Text;
using System.Web;
using System.Data;
using System.Data.SqlClient;
public class OrperateFaHuoInfoFrankXiAn : IHttpHandler 
{
    ...
    private string DeleteTbProcessDataInfo(string labelcode)//string ProductID, string MadeDate)
    {
        try
        {
            using (var myConn = GetConnectionWL())
            {
                ...
                _str1 = "delete TB_ALLInsertFaHuoTest where BoxLabel='" + labelcode + "'";
                if (!_str1.Equals(""))
                {
